...
function Navbar() {
  ...
  return (
    <nav className="nav_main_bar fixed mx-auto z-[100] h-14 top-0 px -inset-x-0 w-full select-none border-b border-gray-200 bg-black bg-opacity-75 backdrop-blur-2xl transition-all">
              ...
              <ul className="flex flex-col xl:flex-row text-right xl:items-center xl:gap-x-5 text-[16px] gap-y-5 xl:mb-0 mb-10 ">
                <li className="py-2 relative">
                  ...
                  <input
                    type="text"
                    placeholder="Search"
                    className="bg-white text-black leading-3 h-8 ps-1"
                  />
                </li>
